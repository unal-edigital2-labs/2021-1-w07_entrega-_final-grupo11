//--------------------------------------------------------------------------------
// Auto-generated by Migen (3ffd64c) & LiteX (8192ad33) on 2021-08-10 19:40:19
//--------------------------------------------------------------------------------
module nexys4ddr(
...
reg [9:0] basesoc_VGA_posX_storage = 10'd0;
reg basesoc_VGA_posX_re = 1'd0;
reg [8:0] basesoc_VGA_posY_storage = 9'd0;
reg basesoc_VGA_posY_re = 1'd0;
wire [11:0] basesoc_data_mem_status;
wire basesoc_data_mem_we;
reg basesoc_data_mem_re = 1'd0;
...
reg builder_csrbank3_VGA_posX0_re = 1'd0;
wire [9:0] builder_csrbank3_VGA_posX0_r;
reg builder_csrbank3_VGA_posX0_we = 1'd0;
wire [9:0] builder_csrbank3_VGA_posX0_w;
reg builder_csrbank3_VGA_posY0_re = 1'd0;
wire [8:0] builder_csrbank3_VGA_posY0_r;
reg builder_csrbank3_VGA_posY0_we = 1'd0;
wire [8:0] builder_csrbank3_VGA_posY0_w;
reg builder_csrbank3_data_mem_re = 1'd0;
wire [11:0] builder_csrbank3_data_mem_r;
reg builder_csrbank3_data_mem_we = 1'd0;
wire [11:0] builder_csrbank3_data_mem_w;
...
assign builder_csrbank3_VGA_posX0_r = builder_interface3_bank_bus_dat_w[9:0];
always @(*) begin
	builder_csrbank3_VGA_posX0_re <= 1'd0;
	builder_csrbank3_VGA_posX0_we <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank3_VGA_posX0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_VGA_posX0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_VGA_posY0_r = builder_interface3_bank_bus_dat_w[8:0];
always @(*) begin
	builder_csrbank3_VGA_posY0_we <= 1'd0;
	builder_csrbank3_VGA_posY0_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 1'd1))) begin
		builder_csrbank3_VGA_posY0_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_VGA_posY0_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_data_mem_r = builder_interface3_bank_bus_dat_w[11:0];
always @(*) begin
	builder_csrbank3_data_mem_we <= 1'd0;
	builder_csrbank3_data_mem_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csrbank3_data_mem_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_data_mem_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_VGA_posX0_w = basesoc_VGA_posX_storage[9:0];
assign builder_csrbank3_VGA_posY0_w = basesoc_VGA_posY_storage[8:0];
assign builder_csrbank3_data_mem_w = basesoc_data_mem_status[11:0];
assign basesoc_data_mem_we = builder_csrbank3_data_mem_we;
...
always @(posedge sys_clk) begin
	...
	if (builder_csrbank3_sel) begin
		case (builder_interface3_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_VGA_posX0_w;
			end
			1'd1: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_VGA_posY0_w;
			end
			2'd2: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_data_mem_w;
			end
		endcase
	end
	if (builder_csrbank3_VGA_posX0_re) begin
		basesoc_VGA_posX_storage[9:0] <= builder_csrbank3_VGA_posX0_r;
	end
	basesoc_VGA_posX_re <= builder_csrbank3_VGA_posX0_re;
	if (builder_csrbank3_VGA_posY0_re) begin
		basesoc_VGA_posY_storage[8:0] <= builder_csrbank3_VGA_posY0_r;
	end
	basesoc_VGA_posY_re <= builder_csrbank3_VGA_posY0_re;
	basesoc_data_mem_re <= builder_csrbank3_data_mem_re;
	...
	if (sys_rst) begin
		...
		basesoc_VGA_posX_storage <= 10'd0;
		basesoc_VGA_posX_re <= 1'd0;
		basesoc_VGA_posY_storage <= 9'd0;
		basesoc_VGA_posY_re <= 1'd0;
		basesoc_data_mem_re <= 1'd0;
...
test_cam test_cam(
	...
	.VGA_posX(basesoc_VGA_posX_storage),
	.VGA_posY(basesoc_VGA_posY_storage),
	.clk(sys_clk),
	.rst(sys_rst),
	.CAM_xclk(CAM_xclk),
	.data_mem(basesoc_data_mem_status)
);
