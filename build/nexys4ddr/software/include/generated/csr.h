...
#define CSR_CAMARA_CNTRL_VGA_POSX_ADDR (CSR_BASE + 0x3800L)
#define CSR_CAMARA_CNTRL_VGA_POSX_SIZE 1
static inline uint32_t camara_cntrl_VGA_posX_read(void) {
	return csr_read_simple(CSR_BASE + 0x3800L);
}
static inline void camara_cntrl_VGA_posX_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x3800L);
}
#define CSR_CAMARA_CNTRL_VGA_POSY_ADDR (CSR_BASE + 0x3804L)
#define CSR_CAMARA_CNTRL_VGA_POSY_SIZE 1
static inline uint32_t camara_cntrl_VGA_posY_read(void) {
	return csr_read_simple(CSR_BASE + 0x3804L);
}
static inline void camara_cntrl_VGA_posY_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x3804L);
}
#define CSR_CAMARA_CNTRL_DATA_MEM_ADDR (CSR_BASE + 0x3808L)
