...
/* uart2 */
#define CSR_UART2_BASE (CSR_BASE + 0x7800L)
#define CSR_UART2_RXTX_ADDR (CSR_BASE + 0x7800L)
...
#define CSR_UART2_EV_PENDING_ADDR (CSR_BASE + 0x7810L)
...
#define CSR_UART2_EV_ENABLE_ADDR (CSR_BASE + 0x7814L)
...
/* ctrl */
#define CSR_CTRL_BASE (CSR_BASE + 0x8000L)
#define CSR_CTRL_RESET_ADDR (CSR_BASE + 0x8000L)
...
#define CSR_CTRL_SCRATCH_ADDR (CSR_BASE + 0x8004L)
...
#define CSR_CTRL_BUS_ERRORS_ADDR (CSR_BASE + 0x8008L)
...
static inline void timer0_update_value_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x880cL);
}
...
static inline void timer0_ev_enable_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x881cL);
}
...
/* uart */
#define CSR_UART_BASE (CSR_BASE + 0x9000L)
#define CSR_UART_RXTX_ADDR (CSR_BASE + 0x9000L)
...
#define CSR_UART_TXFULL_ADDR (CSR_BASE + 0x9004L)
#define CSR_UART_TXFULL_SIZE 1
static inline uint32_t uart_txfull_read(void) {
	return csr_read_simple(CSR_BASE + 0x9004L);
}
#define CSR_UART_RXEMPTY_ADDR (CSR_BASE + 0x9008L)
#define CSR_UART_RXEMPTY_SIZE 1
static inline uint32_t uart_rxempty_read(void) {
	return csr_read_simple(CSR_BASE + 0x9008L);
}
#define CSR_UART_EV_STATUS_ADDR (CSR_BASE + 0x900cL)
...
#define CSR_UART_EV_PENDING_ADDR (CSR_BASE + 0x9010L)
...
#define CSR_UART_EV_ENABLE_ADDR (CSR_BASE + 0x9014L)
