...
_io = [
    ...
    ("CAM_px_data",  0, Pins("E7"), IOStandard("LVCMOS33")),
    ("CAM_px_data",  1, Pins("J3"), IOStandard("LVCMOS33")),
    ("CAM_px_data", 2, Pins("E18"), IOStandard("LVCMOS33")),
    ("CAM_px_data", 3, Pins("J4"), IOStandard("LVCMOS33")),
    ("CAM_px_data", 4, Pins("H2"), IOStandard("LVCMOS33")),
    ("CAM_px_data", 5, Pins("E6"), IOStandard("LVCMOS33")),
    ("CAM_px_data", 6, Pins("H4"), IOStandard("LVCMOS33")),
    ("CAM_px_data", 7, Pins("K1"), IOStandard("LVCMOS33")),
